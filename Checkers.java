...
public class Checkers extends JPanel {
	...
	public static void main(String[] args) {
		...
		System.out.println("keys: 1 (alpha-beta)  2 (MCTS)  3 (hybrid)\n");
    ...
    private class Board extends JPanel implements ActionListener, MouseListener {
        ...
        void doResign() {
            ...
            if (currentPlayer == CheckersData.RED)
                gameOver("RED resigns.  BLACK wins.", true);
            else
                gameOver("BLACK resigns.  RED wins.", true);
            	//previous.drawBoard();
        }
         ...
         */
        void gameOver(String str, boolean resign) {
            message.setText(str);
            ...
            if(!resign) {
            	System.out.println("Game finished with agent taking a total of " + totalMoves + " moves.");
            	System.out.println("Average time for agent to compute one move in this game is: " + (totalTime/ (long)totalMoves));
            }
        }
        ...
        void doMakeMove(CheckersMove move) {	
            ...
            if (currentPlayer == CheckersData.RED) {
                ...
                if (legalMoves == null) {
                    gameOver("BLACK has no moves.  RED wins.", false);
                ...
                System.out.println("Agent took " + (endTime - startTime) + " milliseconds to compute one action");
                System.out.println("---------------------------------------------");
            ...
            legalMoves = board.getLegalMoves(currentPlayer);
            if (legalMoves == null)
                gameOver("RED has no moves.  BLACK wins.", false);
